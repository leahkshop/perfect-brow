...
const VERSION = "pb-v172"; /* v3.32.0 — 꼬리 높이 = 심 아랫끝(옆으로 더 못 나가도 · 기울기 ≤1.3px/열) + 아치두께 그늘 방어(픽셀 판독이 밴드 아랫선보다 max(4px,0.5칸) 아래면 밴드) — 케이스 2 원장님 확인. pb-v171 = v3.31.0 — 꼬리 쪽 판독 열 연속성(trimOutside ⓕ): 이웃 열과 세로로 안 겹치는 바깥 열은 머리카락 (케이스 1·3 실사진 · 랜드마크 경로 첫 재현). pb-v170 = v3.30.0 — 꼬리 심 추적의 머리카락·그늘 덩어리 방어 (원장님 실기기 확인 2026-09-02, 고개 돌린 각도 사진: 꼬리선이 머리카락 속으로): 심 주변 어두운 줄이 max(30px, 밴드 끝 두께×2) 보다 길거나 위아래 12px 에 피부가 없으면 정지. pb-v169 = v3.29.1. */
