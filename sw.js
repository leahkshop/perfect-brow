...
const VERSION = "pb-v162"; /* v3.23.0 — 미러링 점선: v3.15.0(읽은 점 그대로) 위에 규칙 하나만 — 급격한 단차로 튄 구간은 무시하고 튀기 직전 열과 돌아온 열(원장님의 파란점↔파란점)을 직선으로 잇는다. 부드러운 곡선(꼬리·아치)은 건드리지 않음. 판정 그대로. (원장님 지시 2026-09-02, 실제 사진 5장 확인) */
