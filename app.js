...
/* ⭐ v1.97.2 — 동공 세로 기준 0.60 → **0.56** (원장님 지시 2026-08-29:
   「고객 얼굴의 중앙은 조금 위로 올리고」). 위쪽 눈썹 여유는 그대로 충분합니다.
   ⛔ 원장님이 눈으로 맞춘 값 — 임의로 되돌리지 마세요. 회귀 6·44 가 이 상수를 직접 읽습니다. */
const CENTER_Y = 0.56;
...
/* ⚠️ 원장님 정답 반영 2026-08-29: 4번=14 · 7번=9. 확정 6건 9.0·9.4·11.4·11.7·13.5·14.0
   → 중앙값 11.6. 케이스가 늘 때마다 이 값을 갱신합니다 (판독-룰 2-7). */
const FRONT_T_MID = 11.6;     // 눈 위 눈금 — 대체값 (확정 케이스 6건의 중앙값)
