...
> 고친 뒤에는 `node regression-test.mjs` 로 **전 항목(43개)** 을 자동 검증하세요.

> **가로(landscape) 모드 · 양손 조작 기준으로 설계**되었습니다.
>
> ```
> [ 왼손 ]        [        사진 (화면의 90% 이상)        ]  [ 오른손 ]
>  라인 선택 레일    가이드 표시                              위아래 드래그 바 (오른쪽 중앙)
>  Eye/Front/…                                              아래: 보정버튼 / 좌우바 / 메뉴
> ```
>
...
├── regression-test.mjs     ✅ 자동 회귀 테스트 (43항목)
└── README.md               이 문서
```
