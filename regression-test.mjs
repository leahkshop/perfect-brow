...
const NAME229 = "229. 가장자리 어둡게 — 오른쪽(폰 아래) 신설 · 왼쪽(폰 위) 줄임 · 터치 통과";
...
if (RUN(3)) {
  ...
  /* 229. ⭐⭐⭐ v3.69.0 — **가장자리 어둡게 깔기(스크림) 자리** (원장님 지시 2026-09-08, 화면에
     ...
     390×844 세로폰(rot90)에서 원장님이 그어 주신 자리 = 위 띠 끝 y≈170 · 아래 띠 시작 y≈780.
  ...
  const ok229 = sc229.sl && sc229.sr && sc229.sb
    /* 위 띠: 스테이지 위에서 시작해 y≈170 에서 끝난다 — ◀○▶ 슬라이더(끝 118)를 살짝 넘는 자리 */
    && near(sc229.sl.b, 170, 3) && sc229.sl.t === sc229.stage.t
    && sc229.sl.b > sc229.dock.b && sc229.sl.b < sc229.stage.t + 210
  ...
  check(`${JSON.stringify(NAME229).slice(1, -1)} (원장님 지시 2026-09-08)`, ok229,
    `위 띠 ${sc229.sl ? sc229.sl.t + "~" + sc229.sl.b : "없음"}(목표 62~170, 슬라이더 끝 ${sc229.dock.b})`
