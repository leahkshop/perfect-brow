...
if (RUN(0)) {
  ...
  check("39. 왼쪽=위아래 바만 · 오른쪽 위=초기화+다시실행/되돌리기 1행 · 아래 행 [밝기][잠금][미러링] · 왼쪽/오른쪽=미러링 위 · 삭제 정리",
